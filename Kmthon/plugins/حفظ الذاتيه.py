...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗞𝗠𝗧𝗛𝗢𝗡 - حفـظ الذاتـيـة ♥️](t.me/Kmthon) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
