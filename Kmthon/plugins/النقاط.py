...
ZelzalCoins_cmd = (
    "[ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗞𝗠𝗧𝗛𝗢𝗡 - أوامـر تجميـع النقـاط](t.me/Kmthon) 𓆪\n\n"
    "**⎉╎قـائمـة أوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس كـمـثون :** \n\n"
    "`.المليار`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- ملاحظـة :**\n"
    "**⪼ سيتم إضـافـة المزيـد من البوتـات بالتحديثـات القادمـة .. اذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @iNayzak**"
)
