...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗞𝗺𝘁𝗵𝗼𝗻 - أوامـر الصيد والتشيكـر](t.me/Kmthon) 𓆪\n\n"
    ...
    "**- انضـم للقنـاة ~ @Kmthon3**\n"

    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن كـمـثـــون**\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗞𝗺𝘁𝗵𝗼𝗻 - أنـواع اليـوزرات](t.me/Kmthon) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد كـمـثـون 𝗞𝗺𝘁𝗵𝗼𝗻 ⎉",

                    about="This channel to hunt username by - @Kmthon ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت كـمـثـون 𝗞𝗺𝘁𝗵𝗼𝗻 ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس كـمـثـون - @Kmthon ",
