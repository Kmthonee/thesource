...
# =========================================================== #
#                           الملـــف كتـــابـــة مـــن الصفـــر - T.me/Kmthon                           #
# =========================================================== #
...
# =========================================================== #
#                                      نـــأيـــــزك الهيبـــه - T.me/iNayzak                                  #
# =========================================================== #


#Write Code By T.me/iNayzak
@zedub.zed_cmd(pattern="repo(?:\s|$)([\s\S]*)")
async def nayzak2(event):
    ...
    async with event.client.conversation(chat) as conv:
        ...
        await event.client.send_file(
            event.chat_id,
            repo,
            caption=f"<b>⎉╎الريبـو :- <code>{zelzal}</code></b>\n<b>⎉╎تم التحميـل بواسطـة كـمـثون :- @Kmthon</b>",
            parse_mode="html",
            reply_to=reply_id_,
        )
