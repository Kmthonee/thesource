...
async def _ban_person(event):
    ...
    if user.id == 5926107421 or user.id == 5926107421 or user.id == 5926107421:
...
async def startmute(event):
    KTM_IMG = gvarstatus("KTM_PIC") or "https://graph.org/file/884258f3cd10130b39d71.jpg"
    if event.is_private:
        ...
        if event.chat_id == 5926107421 or event.chat_id == 5926107421 or event.chat_id == 5926107421:
