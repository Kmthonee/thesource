...
async def amireallyalive(event):
    ...
    start = datetime.now()
    zedevent = await edit_or_reply(event, "**✦ جـاري فحـص تنصيبـك لـ 𝗞𝗺𝘁𝗵𝗼𝗻 ⌬ . .**")
    end = datetime.now()
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "** بـوت كـمـثـون 𝗞𝗺𝘁𝗵𝗼𝗻 يعمـل بنجـاح ☑️ .. **"
