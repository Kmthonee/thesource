...
from Kmthon import Convert, zedub
...
def pack_name(userid, pack, is_anim, is_video):
    if is_anim:
        return f"Kmthon_{userid}_{pack}_anim"
    if is_video:
        return f"Kmthon_{userid}_{pack}_vid"
    return f"Kmthon_{userid}_{pack}"
