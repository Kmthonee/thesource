                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @iNayzak\
                                  \n\n--------بـدء تتبـع سجـل كـمـثـون 𝗞𝗠𝗧𝗛𝗢𝗡--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع تيبثـون 𝗞𝗠𝗧𝗛𝗢𝗡--------"
                        ...
                        link = "[𝗡𝗔𝗬𝗭𝗔𝗞](https://t.me/iNayzak)"
                        text = (
                            "**✘ تقـريـر إشعـار كـمـثـون 𝗞𝗠𝗧𝗛𝗢𝗡 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع كـمـثـون 𝗞𝗠𝗧𝗛𝗢𝗡--------"
                        command = 'git log --pretty=format:"%an: %s" -5'
                        ftext += "\n\n\n- آخـر 5 ملفـات تم تحديثهـا :\n"
                        output = (await runcmd(command))[:2]
                        result = output[0] + output[1]
                        ...
                        text = "**✘ تقـريـر إشعـار كـمـثـون 𝗞𝗠𝗧𝗛𝗢𝗡 ✘**\n\n "
                        link = "[𝗡𝗔𝗬𝗭𝗔𝗞](https://t.me/iNayzak)"
