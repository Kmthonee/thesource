import sys, asyncio
import Kmthon
from Kmthon import BOTLOG_CHATID, HEROKU_APP, PM_LOGGER_GROUP_ID
...
LOGS = logging.getLogger("سـورس كـمـثون")
cmdhr = Config.COMMAND_HAND_LER

print(Kmthon.__copyright__)
print(f"المرخصة بموجب شروط  {Kmthon.__license__}")

cmdhr = Config.COMMAND_HAND_LER

try: #Code by T.me/iNayzak
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["Kmthon","Kmthon2","Kmthon1","VisaKmthon","Kmthon_Help","Km_Vars","Kmthon3"]
    ...
    LOGS.info(f"⌔ تـم تنصيـب كمثون . . بنجـاح ✓ \n⌔ لـ إظهـار الاوامـر أرسـل (.الاوامر)")
    await verifyLoggerGroup()
