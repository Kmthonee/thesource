...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://t.me/K_M_G_bot
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Kmthonee/thesource"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Kmthon")
